...
<html>
    ...
    <body>
        ...
        <section class="listings">
            <center><h3>ALL YOUR RESULT HERE </h3></center>
            <div class="wrapper">
                <%

                    ArrayList<REstate> buyList = (ArrayList<REstate>) session.getAttribute("searchPro");
                    System.out.print(buyList);
                    if (buyList.size() == 0)
                %>
                <h3 style="margin-left: 10%">There is no result that matching your condition!!! Try again -_- </h3>     
                <%
                ...
                <ul class="properties_list">
                    ...
                    <li>
                        <a href="controller?action=realDetail&id=<%=buyList.get(i).getRealID()%>">
                            <img src="<%= buyList.get(i).getPicture1()%>" alt="" title="" class="property_img"/>
                        </a>
                        <span class="price"><%=buyList.get(i).getPrice()%>$</span>
                        <div class="property_details">
                            <h1>
                                <a href="controller?action=realDetail&id=<%=buyList.get(i).getRealID()%>"><%=buyList.get(i).getStreet()%>, ward <%=buyList.get(i).getWard()%>, district <%=buyList.get(i).getDistrict()%></a>
                            </h1>
            ...
            <div class="future">
                ...
                <div class="content-bottom-in">
                    <ul id="flexiselDemo1">			
                        ...
                        <li><div class="project-fur">
                                <a href="controller?action=buy" ><img class="img-responsive" src="controller?action=buy" alt="" />	</a>
                                <div class="fur">
                                    <div class="fur1">
                                        <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
                                        <h6 class="fur-name"><a href="controller?action=buy">Contrary to popular</a></h6>
