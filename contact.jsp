            ...
            <div class="container">
                ...
                <div class="contact-top">
                    ...
                    <%
                        ...
                        while (rs4.next()) {
                    %>
                    <div class="col-md-6 contact-right" style="margin-left: 250px; border:#000;">

                        <table style="width: 100%">
                            <tr >
                                <td> Owner Name: </td>
                                <td style="float: right"> <%= rs4.getString("full_name")%> </td>
                            </tr>
                            <tr>
                                <td> Email: </td>
                                <td style="float: right"> <%= rs4.getString("owner_email")%> </td>
                            </tr>
                            <tr>
                                <td> Phone: </td>
                                <td style="float: right"> <%= rs4.getString("phone")%> </td>
                            </tr>
                        </table>
                    ...
                    <div class="col-md-6 contact-right" style="margin-left: 250px; border:#000;">
                        You haven't logged in yet - please login? <a href="controller?action=log">login</a>
                    </div>
                    <% }%>
                    <div class="clearfix"> </div>
                </div>
