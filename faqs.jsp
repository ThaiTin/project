...
<%
    ...
    URL base = new URL("http://localhost:8080/real/");
    URL relative = new URL(base, "fqa.xml");
    String url = relative.toString();
    Document doc = db.parse(url);

    NodeList ask = doc.getElementsByTagName("ask");
    ...
    <body>
        ...
        <div class="asked">
            <div class="container">
                ...
                <%
                    int i;
                    for (i = 0; i <= ask.getLength() - 1; i++) {
                %>
                <div class="questions">
                    <h5><%= i + 1%>. <%= ask.item(i).getFirstChild().getNodeValue()%></h5>
                    <p> <%= answer.item(i).getFirstChild().getNodeValue()%>.</p>
                </div>	
                <%
                    }
                %>
