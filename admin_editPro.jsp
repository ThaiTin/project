                    ...
                    <ul class="menu">
                        <li class="item1"><a href="#"> Menu<i class="glyphicon glyphicon-menu-down"> </i> </a>
                            <ul class="cute">
                                ...
                                <li class="subitem2"><a href="rent.jsp">Rent </a></li>
                        ...
                        <div class="col-sm-5 middle-side immediate">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right"><%= roomName.getInt("number_room")%></td>
                                </tr>
                                <% }%>
                        ...
                        <div class="map-buy-single1">
                            ...
                            <script>
                                function myMap() {
                                    ...
                                    var mapOptions = {
                                        center: new google.maps.LatLng(10.7956242, 106.6353634, 13.59),
                                        zoom: 10
                                    }
