                ...
                <table  width="90%">
                    <tbody><tr> 
                        ...
                        <%
                            ...
                            String sql = "Select account.User_ID,account.Fullname, account.Username, account.Pass_word, account.Email, account.Phone_Num, role.Role_Name from account INNER JOIN role on account.Role_ID = role.Role_ID WHERE account.Role_ID != 2 && account.Role_ID != 1  ";
