            ...
            <div class="wrapper">
                <ul class="properties_list">
                    <%
                        ...
                        // sql4 = "Select * from realestate where ";
                        while (rs4.next()) {
                    ...
                    %>
                    <li>
                        <a href="controller?action=detailInfor&id=<%=rs4.getInt("id_real")%>">
                            <img src="<%=rs5.getString("url")%>" alt="" title="" class="property_img"/>
                        </a>
                        <span class="price"><%= rs4.getInt("price")%>$</span>
                        <div class="property_details">
                            <h1>
                                <a href="controller?action=detailInfor&id=<%=rs4.getInt("id_real")%>"><%= rs4.getString("street")%>, ward <%= rs4.getString("wart")%>, district <%= rs4.getString("district")%></a>
                            </h1>
